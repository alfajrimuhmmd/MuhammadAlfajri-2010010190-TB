...
public class tranksaksiPrint extends javax.swing.JFrame {

    ConfigDB myObject;
    int id;
        
    public tranksaksiPrint() {
        initComponents();
        rbtnAll.setSelected(true);
        id = 0 ;
        
        myObject = new ConfigDB ();
        String judulkolom[] = {"ID Transaksi","ID Pelanggan","ID Penyewaan","Biaya Sewa","Lama Sewa","Total Biaya","Tanggal Pinjam","Tanggal Kembali"};
        int lebarkolom[] = {100, 100, 100, 100, 100, 100, 100, 100 };
        
        
        myObject.tampilTable(judulkolom,"SELECT * FROM tbtransaksi",tableTampil);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CETAK DATA TRANSAKSI");

        jLabel2.setText("Cetak data Transaksi");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       if (rbtnAll.isSelected()){
            myObject.tampilLaporan("src/printout/printTransaksi.jrxml","SELECT * FROM tbtransaksi");
        } else if(rbtnSelected.isSelected()){
            String SQL = "SELECT * FROM tbtransaksi where id_transaksi =" + id;
            System.out.println(SQL);
            myObject.tampilLaporan("src/printout/printTransaksi.jrxml",SQL);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tranksaksiPrint.class.getName()).
